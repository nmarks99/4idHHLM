...
BEGIN
{
	...
	#! $ENV{IOC_BINARY}="4idHHLM";
	
	
	# Top-level bin directory for the IOC
	$ENV{IOC_BIN_DIR}="$ENV{TOP}/bin";
	#! $ENV{IOC_BIN_DIR}="/home/username/epics/synApps/support/4idHHLM/bin";
	...
	#! $ENV{IOC_STARTUP_DIR}="/home/username/epics/ioc/synApps/4idHHLM/iocBoot/ioc4idHHLM";
	...
	#! $ENV{IOC_COMMAND_DIR}="/home/username/epics/ioc/synApps/4idHHLM/iocBoot/ioc4idHHLM/softioc/commands";
